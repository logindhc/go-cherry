...
![cherry license](https://img.shields.io/github/license/cherry)
![go version](https://img.shields.io/github/go-mod/go-version/cherry)
![cherry tag](https://img.shields.io/github/v/tag/cherry)
...
- **`examples`示例已从cherry库迁出，新仓库地址: https://cherry-game/examples**
...
源码位于[examples/demo_chat](https://cherry-game/examples/tree/master/demo_chat)仓库
...
请参考[环境安装与配置](https://cherry-game.github.io/guides/install-go.html) 进行准备工作
源码位于[examples/demo_cluster](https://cherry-game/examples/tree/master/demo_cluster)仓库
